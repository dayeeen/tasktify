...
<head>
    ...
    <title>Tasktify</title>
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&amp;display=swap">
</head>
<body>
    <nav class="navbar navbar-expand-md fixed-top navbar-shrink py-3 navbar-light" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span>Tasktify</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><a class="btn btn-primary shadow" role="button" href="login" style="border-radius: 50px;">Sign up</a>
            </div>
        </div>
    </nav>
    <header class="pt-5">
        <div class="container pt-4 pt-xl-5" id="home">
            <div class="row pt-5" style="margin-bottom: 50px;">
                <div class="col-md-8 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <h1 class="display-4 fw-bold mb-5">Empower your day, Manage your&nbsp;<span class="underline">way</span>!</h1>
                ...
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="text-center position-relative"><img class="img-fluid" src="img/desc.png" style="width: 800px;"></div>
                </div>
            </div>
        </div>
    </header>
    <section>
        <div class="container py-4 py-xl-5" id="features" style="padding-bottom: 0px;margin-bottom: 0px;">
            <div class="row">
                <div class="col">
                    <h3 class="display-6 fw-bold pb-md-4" style="text-align: center;margin-right: 0px;padding-right: 0px;padding-bottom: 0px;margin-bottom: 0px;">Features that make yourself more&nbsp;&nbsp;<span class="underline">productive</span>!</h3>
                </div>
            </div>
                        ...
                        <div class="row gy-2 row-cols-1 row-cols-sm-2">
                            <div class="col text-center text-md-start">
                                <div class="d-flex justify-content-center align-items-center justify-content-md-start"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-sun fs-3 text-primary bg-secondary">
                                    ...
                                    <h5 class="fw-bold mb-0 ms-2" style="font-size: 19px;">Task Organization:</h5>
                                </div>
                                <p class="text-muted my-3">Categorize your tasks with ease and stay on top of your to-do list effortlessly.</p>
                            </div>
                            <div class="col text-center text-md-start">
                                <div class="d-flex justify-content-center align-items-center justify-content-md-start"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-sun fs-3 text-primary bg-secondary">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    ...
                                    <h5 class="fw-bold mb-0 ms-2" style="font-size: 19px;">Deadline Tracking:</h5>
                                </div>
                                <p class="text-muted my-3">Set deadlines for your tasks and receive timely reminders to ensure nothing gets overlooked.</p>
                            </div>
                            <div class="col text-center text-md-start">
                                <div class="d-flex justify-content-center align-items-center justify-content-md-start"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-sun fs-3 text-primary bg-secondary">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    ...
                                    <h5 class="fw-bold mb-0 ms-2" style="font-size: 19px;">User-Friendly Interface:</h5>
                                </div>
                                <p class="text-muted my-3">Tasktify provides a clean and intuitive interface, making task management a breeze for users of all levels.</p>
                            </div>
                            <div class="col text-center text-md-start">
                                <div class="d-flex justify-content-center align-items-center justify-content-md-start"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-sun fs-3 text-primary bg-secondary">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    ...
                                    <h5 class="fw-bold mb-0 ms-2" style="font-size: 19px;">Progress Monitoring:</h5>
                                </div>
                                <p class="text-muted my-3">Track the completion status of your tasks and celebrate your achievements along the way.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 order-first order-md-last">
                    <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;padding: 0px;padding-bottom: 0px;margin: 0px;margin-left: 0px;margin-bottom: 0px;padding-right: 0px;margin-right: 0px;" src="img/Schedule.png" width="476" height="300"></div>
                </div>
            </div>
        </div>
    </section>
    <section class="py-5" id="contacts" style="margin-bottom: 0px;">
        <div class="container py-4 py-xl-5" style="margin-top: -48px;">
            ...
            <section class="position-relative py-4 py-xl-5">
                <div class="container position-relative">
                    <h3 class="display-6 fw-bold pb-md-4" style="text-align: center;">Get In&nbsp;<span class="underline">Touch</span>:</h3>
    ...
    <section class="py-4 py-xl-5 mb-5" id="faq">
        <div class="container">
            <div class="row mb-2">
    ...
    <footer>
        <div class="container py-4 py-lg-5">
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">Copyright © 2023 Tasktify</p>
